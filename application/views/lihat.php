    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-6">
                  ...
                  <div class="frame">
                      <iframe src="<?= base_url(); ?>assets/surat/<?= $berita->file ?>" class="surat" allowfullscreen frameborder="0"></iframe>
                  </div>
                  <br>
                  <div class="row" style="margin-bottom: 30px;">
                      <button type="submit" class="btn btn-warning" onclick="window.location.href='<?= base_url(); ?>'"><< kembali </button>
                      <button type="submit" class="btn btn-success" onclick="window.location.href='<?= base_url(); ?>/Surat_c/UnduhSurat/<?= $berita->id?>'">Unduh</button>
                      <button type="submit" class="btn btn-info" data-toggle="modal" data-target="#edit">Edit/ Ganti file</button>
                  </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <?php echo form_open_multipart('Surat_c/EditSurat/'. $berita->id); ?>
