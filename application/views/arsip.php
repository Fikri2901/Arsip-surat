...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Arsip Surat >> Unggah</h1>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-6">
                <?php echo form_open_multipart('Surat_c/TambahSurat'); ?>
                    ...
                    <br>
                    <div class="row">
                        <button type="button" class="btn btn-warning" onclick="window.location.href='<?= base_url(); ?>'"><< Keluar</button>
